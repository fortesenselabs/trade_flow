...
from metatrader.enums import SymbolFilterType
...
class ExchangeInfoService:
    ...
    def do(self, opts=None):
        ...
        data = self.client.call_api("GET", endpoint, params)
...
# exchange_info_service = ExchangeInfoService(client)
# exchange_info = exchange_info_service.symbol("BTCUSDT").do()
# print(exchange_info.timezone)
