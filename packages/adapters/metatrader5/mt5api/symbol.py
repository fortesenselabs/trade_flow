...
class _MT5SymbolDetails:
    """
    MT5SymbolDetails class to be used.

    Also known as SymbolInfo
    """
...
def convert_symbol_info_to_mt5_symbol_details(symbol_info: SymbolInfo, broker_server: str) -> MT5SymbolDetails:
    return MT5SymbolDetails(
        underSecType=symbol_info.path.split("\\")[0].upper(),
        symbol=MT5Symbol(symbol=symbol_info.name, broker=broker_server),
