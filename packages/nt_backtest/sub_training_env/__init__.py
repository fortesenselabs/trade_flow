"""
Create an OMS for it OR find a way to use the already underlying nautilus trader system
- The first approach seems tedious but simpler 
...
def create(
    ...
    **kwargs,
    ...
    """Creates the default `TradingEnvironment` of the project to be used in training
    RL agents.
