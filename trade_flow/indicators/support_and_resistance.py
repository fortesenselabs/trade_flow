...
class OptimizedSupportResistanceIndicator(SupportResistanceIndicator):
    ...
    TODO: fix ImportError: Numba needs NumPy 2.0 or less. Got NumPy 2.1.
    ...
    @numba.njit
    def _calculate_pivot_points_array(self, high, low, close):
        """
        ...
        Returns:
            tuple: Arrays of calculated pivot points and support/resistance levels.
        """
        length = len(high)
    ...
    def calculate_pivot_points(self):
        ...
        pivot_points, resistance_1, support_1, resistance_2, support_2, resistance_3, support_3 = (
            self._calculate_pivot_points_array(high, low, close)
        )
    ...
    @numba.njit
    def _detect_local_min_max(self, lows, highs, window_size):
        """
    ...
    def detect_local_min_max(self, window_size: int = 5):
        ...
        support_indices, resistance_indices = self._detect_local_min_max(lows, highs, window_size)
