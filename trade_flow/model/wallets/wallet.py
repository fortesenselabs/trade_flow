...
from trade_flow.model.instruments import Instrument, Quantity, ExchangePair
from trade_flow.model.orders import Order
from trade_flow.model.venues import Venue
from trade_flow.model.wallets.ledger import Ledger
...
class Wallet(Identifiable):
    """A wallet stores the balance of a specific instrument on a specific venue.

    Parameters
    ----------
    venue : `Venue`
        The venue associated with this wallet.
    balance : `Quantity`
    ...
    def __init__(self, venue: "Venue", balance: "Quantity"):
        self.venue = venue
    ...
    def transfer(
        ...
        converted = target.deposit(
            converted, "TRADED {} {} @ {}".format(quantity, exchange_pair, exchange_pair.price)
        )
