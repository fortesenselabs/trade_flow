...
from trade_flow.adapters.metatrader5.mt5api.decoder import Decoder
from trade_flow.adapters.metatrader5.mt5api.common import CommissionReport, BarData
from trade_flow.adapters.metatrader5.mt5api.execution import Execution
...
from trade_flow.adapters.metatrader5.common import MT5_VENUE
from trade_flow.adapters.metatrader5.client.connection import MetaTrader5ClientConnectionMixin
from trade_flow.adapters.metatrader5.client.account import MetaTrader5ClientAccountMixin
from trade_flow.adapters.metatrader5.client.symbol import MetaTrader5ClientSymbolMixin
from trade_flow.adapters.metatrader5.client.market_data import MetaTrader5ClientMarketDataMixin
from trade_flow.adapters.metatrader5.client.order import MetaTrader5ClientOrderMixin

# from trade_flow.adapters.metatrader5.client.error import MetaTrader5ClientErrorMixin
from trade_flow.adapters.metatrader5.client.common import (
    AccountOrderRef,
    Request,
    Requests,
    Subscriptions,
...
class MetaTrader5Client(
    ...
    def __init__(
        ...
        self._max_connection_attempts: int = int(os.getenv("MT5_MAX_CONNECTION_ATTEMPTS", 0))
    ...
    async def _run_connection_watchdog(self) -> None:
        ...
        try:
            while True:
                ...
                if not self._is_mt5_connected.is_set() or not self._mt5Client.is_connected():
                    self._log.error(
    ...
    async def _handle_disconnection(self) -> None:
        ...
        if self._is_mt5_connected.is_set():
            self._log.debug("`_is_mt5_connected` unset by `_handle_disconnection`.", LogColor.BLUE)
    ...
    async def _run_terminal_incoming_msg_reader(self) -> None:
        ...
        try:
            ...
            self._log.exception("Unhandled exception in Client Terminal incoming message reader", e)
        finally:
    ...
    async def _run_internal_msg_queue_processor(self) -> None:
        ...
        try:
            while self._mt5Client.is_connected() or not self._internal_msg_queue.empty():
