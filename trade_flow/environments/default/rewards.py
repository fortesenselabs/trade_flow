...
class TradeFlowRewardScheme(RewardScheme):
    ...
    def get_reward(self, portfolio) -> float:
        ...
        ----------
        portfolio : `Portfolio`
            The portfolio associated with the `TradeFlowActionScheme`.
...
class SimpleProfit(TradeFlowRewardScheme):
...
class RiskAdjustedReturns(TradeFlowRewardScheme):
...
def get(identifier: str) -> "TradeFlowRewardScheme":
