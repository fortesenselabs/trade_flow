...
class SimpleOrders(TradeFlowActionScheme):
    ...
    def action_space(self) -> Space:
        if not self._action_space:
            self.actions = product(
                self.criteria, self.trade_sizes, self.durations, [TradeSide.BUY, TradeSide.SELL]
            )
...
class ManagedRiskOrders(TradeFlowActionScheme):
