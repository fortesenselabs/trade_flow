...
class BSSH(TensorTradeActionScheme):
    ...
    def exitShort(self):
        ...
        if current_asset_quantity > self.borrow_quantity:
            ...
            borrow_remainder_cash = (self.borrow_quantity - current_asset_quantity).convert(
                self.exchange_pair
            )
            ...
            short_exit_commission = (
                self.borrow_quantity.convert(self.exchange_pair) * self.commission
            )
    ...
    def maintainShort(self):
        ...
        borrow_threshold_cash = self.maintenance_margin * self.borrow_quantity.convert(
            self.exchange_pair
        )
