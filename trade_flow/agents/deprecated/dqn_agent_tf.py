...
class TensorFlowDQNAgent(Agent):
    ...
    def _build_policy_network(self):
        ...
        inputs = tf.keras.layers.Input(shape=self.observation_shape, dtype="float32")
        ...
        concat_conv_3 = tf.keras.layers.Concatenate()([norm_7, norm_8, norm_9])
        ...
        dense_3 = tf.keras.layers.Dense(
            units=16, activation=tf.keras.layers.PReLU(), kernel_initializer="he_uniform"
        )(dense_2)
