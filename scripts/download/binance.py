...
from application.utils.binance import klines_to_df, binance_freq_from_pandas
...
def main(config_file):
    ...
    App.client = Client(
        api_key=App.config["api_key"], api_secret=App.config["api_secret"]
    )
    ...
    for ds in data_sources:
        ...
        file_name = (file_path / ("futures" if futures else "klines")).with_suffix(
            ".csv"
        )
